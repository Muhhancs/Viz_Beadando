...
namespace VideoTeka
{
    public partial class Form2 : Form
    {
        ...
        int max_page = 0;
        int total_found = 0;
        List<Search> flista = new List<Search>();
        public Form2()
        {
            InitializeComponent();
        ...
        {
            this.Hide();
            //List <Search> van_e = gyors(tb_search.Text, page);
            //string id = ;
            Form3 f3 = new Form3(flista[page * 10].imdbID);
            f3.ShowDialog();
        }
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
            this.Hide();
            //List<Search> van_e = gyors(tb_search.Text, page);
            //string id = van_e[1].imdbID;
            Form3 f3 = new Form3(flista[page * 10 + 1].imdbID);
            f3.ShowDialog();
        }
        ...
        {
            this.Hide();
            Form3 f3 = new Form3(flista[page * 10 + 2].imdbID);
            f3.ShowDialog();
        }
        ...
        {
            this.Hide();
            Form3 f3 = new Form3(flista[page * 10 + 3].imdbID);
            f3.ShowDialog();
        }
        ...
        {
            this.Hide();
            Form3 f3 = new Form3(flista[page * 10 + 4].imdbID);
            f3.ShowDialog();
        }
        ...
        {
            this.Hide();
            Form3 f3 = new Form3(flista[page * 10 + 5].imdbID);
            f3.ShowDialog();
        }
        private void pictureBox7_Click(object sender, EventArgs e)
        {
            this.Hide();
            Form3 f3 = new Form3(flista[page * 10 + 6].imdbID);
            f3.ShowDialog();
        }
        private void pictureBox8_Click(object sender, EventArgs e)
        {
            this.Hide();
            Form3 f3 = new Form3(flista[page * 10 + 7].imdbID);
            f3.ShowDialog();
        }
        private void pictureBox9_Click(object sender, EventArgs e)
        {
            this.Hide();
            Form3 f3 = new Form3(flista[page * 10 + 8].imdbID);
            f3.ShowDialog();
        }
        private void pictureBox10_Click(object sender, EventArgs e)
        {
            this.Hide();
            Form3 f3 = new Form3(flista[page * 10 + 9].imdbID);
            f3.ShowDialog();
        }
